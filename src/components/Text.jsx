...
export default function Text() {
 ...
 <div className="flex flex-col gap-[24px] mx-[30px] mx-[30px] md:px-[221px] py-[96px] ">
        <h3 className="text-[#232536] text-[36px]">Transform Your Idea Into Reality with Ether a <br /> Leading Digital Agency</h3>
        <p className="text-[#232536] text-[16px] ">Writing UX copies can be a little frustrating and confusing, and sometimes we are unsure about how to get the right word. To crack the code for the UX copies, we at Zeta Design wanted to build a Figma plugin for the larger design community. The plugin is called the Ghost UXWriter and has a set of UX copies cataloged and categorized with a voice and tone variation ranging from plain, casual to playful. The intention to build this Figma plugin originated from our Medium blog post, ‘Designing voice and tone for error messages.</p>
        ...
        <h4 className="text-[#232536] text-[36px]">We disclose your information in the following manner:</h4>
        <p className="text-[#232536] text-[16px] ">Business partners, suppliers and sub-contractors (“Affiliates”): Affiliates may use this information to help provide, understand, and improve our services and Affiliate’s own services for the performance of any contract we enter into <br /> <br />

Financial Institutions and Auditors: In order to complete third party financial, technical and legal audits of our operations to help us operate our business, we may need to share your information with financial institutions and auditors. <br /><br />
